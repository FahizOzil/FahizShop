...
<div class="container-fluid">
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-4">
                <x-card title="Kamet Efficitur Ligula" url="images/p1.jpg" price=12500 style="width:20rem;" />
            </div>
            <div class="col-md-4">
                <x-card title="Kamet Efficitur Ligula" url="images/p1.jpg" price="12500" style="width:20rem;" />
            </div>
